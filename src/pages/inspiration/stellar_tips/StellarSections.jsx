...
class StellarSections extends React.Component {
  ...
  render() {
    const { essentialTips, flavorTips, proTips, quickTips } = this;
        ...
        <main className="container my-5">
          ...
          <section className="tips-category mb-5">
            <div className="category-header">
              ...
              <p className="category-desc">
                Master these fundamental skills and watch your cooking orbit to new heights
              </p>
            </div>
          ...
          <section className="tips-category mb-5">
            <div className="category-header">
              ...
              <p className="category-desc">Unlock stellar flavors with these cosmic cooking secrets</p>
            </div>
          ...
          <section className="tips-category mb-5">
            <div className="category-header">
              ...
              <p className="category-desc">Insider techniques from the culinary constellation</p>
            </div>
            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-8">
                <div className="secret-badge">
                  ...
                  Chef's Secret of the Week
                </div>
                <h3 className="secret-title">The Power of Umami Bombs</h3>
                <p className="secret-description">
                  Boost savory depth in any dish with "umami bombs" like tomato paste, soy sauce, miso, Parmesan rind, anchovies, or
                  dried mushrooms. These ingredients add profound savory complexity without being identifiable. Just a small amount
                  can transform a good dish into an unforgettable one. Try adding a teaspoon of tomato paste to your next pasta sauce
                  or a splash of soy sauce to your beef stew!
                </p>
                <div className="secret-stats">
                  ...
                  <div className="stat-item">
                    <strong>Works Best In:</strong> Soups, Sauces, Braises
                  </div>
                </div>
              </div>
